...
urlpatterns = [
    ...
    path('appuser/update/<int:pk>/', views.create_appuser_ui, name="edit_appuser"),
    ...
    # ═══════════════════════════════════════════════════════
    # APP USER AUTH APIs  (number + email dono support karte hain)
    # ═══════════════════════════════════════════════════════
    ...
    path("api/forgot-password/", api_view.forgot_password, name='forgot_password'),
    path("api/reset-password/", api_view.reset_password, name='reset_password'),
    ...
    path('api/discount-popup/', api_view.active_discount_popup, name='active_discount_popup'),
